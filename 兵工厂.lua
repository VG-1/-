...
local Window = OrionLib:MakeWindow({Name = "KiNG脚本", HidePremium = false, SaveConfig = false, IntroText = "霖溺脚本", ConfigFolder = "霖溺脚本"})
...
local function API_Check()
        ...
        _G.LineColor = Color3.fromRGB(0, 1, 0.749019)   -- The color that the boxes would appear as.

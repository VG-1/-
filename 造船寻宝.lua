...
local win = UILib:Window("King Script丨造船寻宝",Color3.fromRGB(102, 255, 153), Enum.KeyCode.RightControl)
...
local setup = win:Tab("介绍")
    ...
    setup:Label("本次开启为造船寻宝脚本")

    local Tab = win:Tab("主要的功能")
    local Tab2 = win:Tab("娱乐功能")
    local Tab3 = win:Tab("角色功能")
    local King = win:Tab("作者信息")

Tab:Toggle("自动刷金币", "text", false, function(FARM)
        _G.FARMs = FARM
        while _G.FARMs do
            wait()
            pcall(
...
Tab:Toggle("自动刷金币快速版", "text", false, function(FARM2)
        _G.FARM2s = FARM2
        while _G.FARM2s do
            wait()
            pcall(
...
Tab:Toggle(
    "自动索赔金币", "text", false, function(GlaimGold)
...
King:Button("作者QQ群，点击我复制", function()

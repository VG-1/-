...
local win = UILib:Window("King Script丨举重模拟器",Color3.fromRGB(102, 255, 153), Enum.KeyCode.RightControl)
...
local setup = win:Tab("介绍")
    ...
    setup:Label("本次开启为举重模拟器脚本")

local tab = win:Tab("主要功能")

tab:Toggle("自动举重", false, function(Value)
toggle = Value
...
tab:Toggle("自动售卖", false, function(Value)
    tog = Value
   while tog do wait()
local ohTable1 = {
	[1] = "SellMuscle"

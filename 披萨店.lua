...
local win = UILib:Window("King Script丨披萨店",Color3.fromRGB(102, 255, 153), Enum.KeyCode.RightControl)
...
local setup = win:Tab("介绍")
    ...
    setup:Label("本次开启为披萨店脚本")
    
    linni:Button("点击我复制QQ群链接",function()
setclipboard("霖溺QQ新主群https://qm.qq.com/q/SU0hmhIvwk")
end)

local W = win:Tab("主要功能")
W:Label("用的OrionLib的UI")

W:Button("选择员工工作",function()

local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Hunryn/VB/main/OrionLib.ui.lua"))()

local Window = OrionLib:MakeWindow({Name = "King脚本", IntroIcon = "rbxassetid://18216647696", HidePremium = false, SaveConfig = true,IntroText = "King脚本", ConfigFolder = "King脚本"})
...
local pizzaPart = game.ServerStorage.PizzaPart 
